...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE students SET name=%s, age=%s, email=%s WHERE id=%s",
...
mysql_select_db($database_myconnect, $myconnect);
$query_Recordset1 = sprintf("SELECT * FROM students WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
